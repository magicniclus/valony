...
const StepEng = () => {
    ...
    const [step, setStep] = useState<number>(1);
     const [title, setTitle] = useState<string>('For more information, it’s here ');
                        ...
                        <div className='flex'>
                            {
                                ...
                                <div className={`flex md:w-[450px] justify-between ${!getFocus && "backgroundTelOneContainer"}`}>
                                    ...
                                    >
                                        <option value="" disabled>{getFocus ? 'Country Code' : ""}</option>
                                ...
                                <div className='w-full flex flex-col mb-5'>
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <label className='ml-3'>I have read and accept the privacy policy of this site.*</label>
                                    </div>
