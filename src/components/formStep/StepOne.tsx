      ...
      <div className="font-outfit">
        <div>
          <div
            ...
            } bg-transparent relative md:min-w-[470px]`}
          >
            <div
            ...
            >
              <p
                className={`lg:hidden flex flex-col font-outfit text-white uppercase text-[14px] transition duration-300 ease-in-out ${
                  step < 4 ? " " : "hidden"
                } ${
                  getFocus
                    ? "-translate-y-[calc(100%px)] "
              ...
              <p
                className={`lg:text-[16px] text-[16px] flex-col font-outfit text-white uppercase items-end absolute top-0 left-0 transition duration-300 ease-in-out lg:flex hidden ${
                  getFocus ? "lg:-translate-y-[calc(100%+5px)] " : ""
                } ${step < 4 ? " " : "hidden"}`}
              >
                {title}
              </p>
            ...
            <div className="flex">
              {step < 3 ? (
                ...
                <div className="w-full flex flex-col mb-5">
                  <div className="text-[14px] text-white flex md:flex-row flex-col justify-between">
              ...
              <button
                ...
                className={`${step < 4 ? " " : "hidden"} text-white`}
              >
                <img
                  src="/icons/arrow-white-circle.png"
                  alt="arrow-right"
