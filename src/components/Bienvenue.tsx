        ...
        <section className="flex 2xl:max-h-[750px]">
          <div className="w-[121px] px-4 py-6 hidden lg:flex flex-col items-center justify-between">
            <div className="w-full">
              <div className="w-full">
                <div className="flex justify-center min-w-max -translate-x-[110px]">
                  <p
                    className="text-or text-[16px] rotate-[270deg] translate-y-40 uppercase font-outfit font-bold"
                    style={{ width: "max-content" }}
                  >
                    &rsaquo; GROUPE DUVAL, GAGE DE PÉRENNITÉ
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full flex md:flex-row flex-col">
            <div className="md:w-[50%] w-full overflow-hidden md:hidden flex justify-between flex-col">
              <div className="h-1/3 w-full relative overflow-hidden">
                <p
                  className="absolute text-white font-bold text-[45px] bottom-3 left-5 uppercase z-20 font-playfair"
                  ref={titleRef1}
                >
                  agilité
                </p>
                <img
                  src="/images/agilite.jpg"
            ...
            <div className="md:w-[50%] w-full overflow-hidden flex 2xl:justify-center md:justify-between bg-grayClear flex-col px-4 md:px-14 py-14">
              <h2
                className="sm:text-[45px] text-4xl font-bold text-blueClear leading-[50px] font-playfair"
                ref={titleRef}
              >
                Bienvenue à bord
              </h2>
              <div className="md:mt-3 mt-6" ref={logoRef}>
                ...
                />
                <h3 className="text-[20px] font-outfit text-or mt-3 uppercase tracking-[3px] leading-[36px]">
                  Plus de 25 ans d’expérience
                </h3>
              </div>
              <p
                className="text-[17px] font-outfit font-bold md:mt-3 mt-6"
                ref={paraphRef}
              >
                Concevoir des espaces à vivre au service de l’exigence des
                usagers et dans le plus grand respect des territoires, c’est la
                raison d’être du Groupe Duval depuis plus de 25 ans. Outre les
                garanties « constructeur », acheter dans le neuf offre de
                nombreux atouts : frais de notaires réduits, performances
                environnementales, confort au quotidien…
              </p>
              <div
                className="flex flex-col text-[14px] w font-outfit md:mt-5 mt-10 lign relative md:w-[377px]"
                ref={listRef}
              >
                <div className="flex">
                  <img
                    ...
                    alt="bullet"
                    className="w-[9px] h-[9px] translate-y-1.5 mr-2"
                  />
                  <p className="text-text flex">
                    Je suis intéressé(e) par l’acquisition d’un appartement
                    VALONY à Poitiers.
                  </p>
                </div>
                <div className="overflow-hidden group mt-9">
                  <a
                    href="#hero"
                    className="translate-x-1 flex bg-white rounded-r-full px-7 py-2 max-w-max text-or mt-3 items-center"
                    ref={buttonRef2}
                  >
                    ...
                    <img
                      ...
                      className="ml-2 h-[9px] group-hover:translate-x-2 transition duration-150 ease-in-out"
                      alt="arrow"
                    />
                  </a>
                </div>
                ...
                <div className="flex mt-14">
                  ...
                  />
                  <p className="text-text flex">
                    Je reçois l’appel ou le message d’un conseiller qui connait
                    parfaitement l’emplacement de ces villas, leurs prestations,
                    et qui saura me renseigner au mieux.
                  </p>
                </div>
              </div>
            </div>
