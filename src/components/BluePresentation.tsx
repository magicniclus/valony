...
const BluePresentation : React.FC<BluePresentationProps> = ({ navTitle, navPourcentage, title, susTitle, list, button }) => {
    return (
        <section className='flex'>
            ...
            <div className='w-full flex md:flex-row flex-col'>
                <div className='md:w-[50%] w-full min-h-[559px] overflow-hidden flex justify-between items-center bg-gray bg-cover bg-center' style={{"backgroundImage": "url(/images/oleron.jpg)"}}></div>
                <div className='md:w-[50%] w-full min-h-[559px] overflow-hidden flex justify-between items-center bg-blueClearClear flex-col px-14 py-8'>
                    ...
                    <div className='w-full mt-3'>
                        <button className='bg-white group text-[20px] font-outfit text-blueClear py-2 px-4 rounded-full mt-4 uppercase hover:bg-blueClear hover:text-white flex items-center transition duration-300 ease-in-out'>
                            {button}
